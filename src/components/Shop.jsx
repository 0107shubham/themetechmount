          ...
          >
            <div className="w-full relative overflow-hidden">
              ...
              <button
                ...
                className="absolute transform translate-y-[10vw] transition-transform duration-1000 ease-in-out group-hover:translate-y-0 bottom-0 text-white w-full h-[4vw] bg-purple-400"
              >
                Add to Cart
              </button>
            </div>
